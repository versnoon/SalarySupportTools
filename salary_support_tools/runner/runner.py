...
from salary_support_tools.model.export.sh001_export_model import Sh001Export
from salary_support_tools.model.export.tex_export_one_file_model import TexOneFileExport, TexSpecialOneFileExport
from salary_support_tools.model.export.err_message_one_file_model import ErrMessageOneFileExport
...
class Runner:
    ...
    def run(self):
        ...
        util = ModelToXls([GzExport(period, gzs), JjExport(
            period, jjs), AuditorExport(period, merge_infos), Sh002Export(period, merge_infos), Sh003Export(period, merge_infos), Sh001Export(period, merge_infos), TexExport(period, merge_infos), TexSpecialExport(period, merge_infos), ErrMessageExport(period, merge_infos), Sh003ByTexDepartExport(period, merge_infos), Sh002OneFileExport(period, merge_infos), TexOneFileExport(period, merge_infos), TexSpecialOneFileExport(period, merge_infos), ErrMessageOneFileExport(period, merge_infos)])
        util.export()
